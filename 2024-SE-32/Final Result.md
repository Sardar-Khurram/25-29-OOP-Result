...
**Dear Muhammad,** your Lab 1 submission is missing from your repository. Please upload your complete Lab 1 structures and pointers C++ code to receive evaluation.
...
| **Criteria** | **Max Marks** | **Marks Obtained** | **Teacher's Feedback & Explanation** |
| :--- | :---: | :---: | :--- |
| **Class Definition & Object Usage** | 3 | **0** | **Not Attempted.** No code files or directories exist in your repository for Lab 2. |
| **Member Variables** | 3 | **0** | **Not Attempted.** No member variables were declared. |
| **Member Functions (Inside/Outside)** | 3 | **0** | **Not Attempted.** No member functions were declared or defined. |
| **Input/Output & Execution** | 3 | **0** | **Not Attempted.** No C++ source files exist to compile or execute. |

---

### **Summary of Results**
* **Total Marks:** **0 / 12** (0.0%)
...
### 💬 **Overall Teacher Remarks**
Dear Muhammad Hasham, Your `Lab#03` folder contains an empty 1-byte file. Please upload your complete Lab 3 code to receive evaluation.
...
### 💬 **Overall Teacher Remarks**
Dear Muhammad Hasham, Your `Lab#04` folder contains an empty 1-byte file. Please upload your complete Lab 4 constructor/destructor code to receive evaluation.
...
**Dear Muhammad,** your Lab 5 submission is missing from your repository. Please upload your complete Lab 5 inheritance tasks to receive evaluation.
...
**Dear Muhammad,** your Lab 6 submission is missing from your repository. Please upload your complete Lab 6 constructor/destructor tasks to receive evaluation.
...
**Dear Muhammad,** your Lab 7 submission is missing from your repository. Please upload your complete Lab 7 composition and aggregation tasks to receive evaluation.
...
**Dear Muhammad,** your Lab 12 submission is missing from your repository. Please upload your complete Lab 12 HospitalStaff tasks to receive evaluation.
